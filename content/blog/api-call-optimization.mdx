...
2. **트랜잭션은 데이터 무결성의 핵심**: 여러 단계를 하나의 원자적 작업으로 묶어주면, 중간 상태로 인한 데이터 유실을 방지할 수 있습니다.

3. **UX도 중요하다**: 저장 중 사용자가 다른 작업을 시도하면 예상치 못한 에러가 발생할 수 있습니다. 시각적 피드백과 조작 차단을 통해 더 좋은 사용자 경험(UX)을 제공할 수 있습니다.
